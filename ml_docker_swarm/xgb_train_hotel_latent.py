# python xgb_train_hotel_latent.py --gpus 1 --data-dir ./swarm_data_next_5s_upsample/
# python xgb_train_hotel_latent.py --gpus 0,1 --data-dir  ../logs/hotel_reserve_data/hotel_data_next_5s/
