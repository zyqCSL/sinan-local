...
# param tunning
# python  train_hotel_cnvnet.py --num-examples 31302 --lr 0.001 --gpus 0,1 --data-dir  ../logs/hotel_reserve_data/hotel_data_next_5s --wd 0.001
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log', default='train_cnvnet_hotel.log', type=str)
    parser.add_argument('--num-examples', type=int, required=True, help='the number of training examples')  # window size of 5
    parser.add_argument('--network', type=str, default='cnvnet_hotel')
    parser.add_argument('--model-prefix', type=str, default='./model/cnv_hotel')
